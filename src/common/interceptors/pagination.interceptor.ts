...
export class PaginationInterceptor implements NestInterceptor {
  ...
  private validatePaginationParams(query: any): void {
    const page = this.parseAndValidateNumber(query.page, 'page', PAGINATION.MIN_LIMIT, PAGINATION.MAX_PAGE, PAGINATION.DEFAULT_PAGE);
    const limit = this.parseAndValidateNumber(query.limit, 'limit', PAGINATION.MIN_LIMIT, PAGINATION.MAX_LIMIT, PAGINATION.DEFAULT_LIMIT);
